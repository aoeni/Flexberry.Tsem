...
namespace IIS.Tsem
{
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tsem.Пассажир fПассажир;
        
        private IIS.Tsem.Рейс fРейс;
        ...
        [PropertyStorage(new string[] {
                "Пассажир"})]
        [NotNull()]
        public virtual IIS.Tsem.Пассажир Пассажир
        {
            get
            {
                ...
                IIS.Tsem.Пассажир result = this.fПассажир;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Tsem.Рейс.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Рейс"})]
        public virtual IIS.Tsem.Рейс Рейс
        {
            get
            {
                ...
                IIS.Tsem.Рейс result = this.fРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфБроньE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфБроньE", typeof(IIS.Tsem.ИнфБронь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Tsem.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Tsem.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Tsem.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Tsem.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Tsem.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Tsem.ИнфБронь dataobject)
        {
