...
namespace IIS.Tsem
{
    ...
    [View("ПосадТалонE", new string[] {
            ...
            "Пассажир.ФИО as \'ФИО\'",
            "Пассажир.МестоНаРейс.Место as \'Место на рейс\'",
            "Рейс as \'Рейс\'",
            "Рейс.Куда as \'Куда\'",
    ...
    [MasterViewDefineAttribute("ПосадТалонE", "Рейс", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Выход")]
    ...
    public class ПосадТалон : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосадТалонE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосадТалонE", typeof(IIS.Tsem.ПосадТалон));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПосадТалонL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосадТалонL", typeof(IIS.Tsem.ПосадТалон));
                }
            }
        }
    }
