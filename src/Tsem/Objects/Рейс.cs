...
namespace IIS.Tsem
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tsem.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Tsem.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Tsem.DetailArrayOfИнфБронь(this);
                }
                IIS.Tsem.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Tsem.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Tsem.Рейс));
                }
            }
        }
    }
