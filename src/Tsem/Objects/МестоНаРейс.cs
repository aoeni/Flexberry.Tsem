...
namespace IIS.Tsem
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tsem.КлассБилета fКласс;
        ...
        public virtual IIS.Tsem.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Tsem.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Tsem.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Tsem.МестоНаРейс));
                }
            }
        }
    }
